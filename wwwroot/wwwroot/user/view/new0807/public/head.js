...
//			link += "<a href='?c=public&a=user'>"+this.useremail+"</a>";
			var link = '<h3><a href="?c=public&a=user"><strong style="padding:0 5px 0 0;"><img src="/user/view/new/agies/img/touxiang.jpg" style="border-radius:50%;" /></strong>'+this.useremail+'<span><img src="/user/view/new/agies/img/xiala.png" /></span></a></h3>';
			div.append(link);
		}
		if (this.domainlogin!=0 || this.userlogin != 0) {
			//var link = '<a href="?c=session&a=logout">退出</a>';
			//div.append(link);
			$("#login_out").html('<a href="?c=session&a=logout"><img src="/user/view/new/agies/img/login_out.png" /></a>');
		}
